...
停留在其它玩家的空地或楼房处，需支付相应级别的费用。停留在其 它玩家空地处，支付该处空诸如使用道具，卖房产，查询等操作。掷完馂果福神俯身，可免费，系统提示：“福神附身，可免过路费”； 如果地产的主人在医院或监狱中，也免过路费。
...
7.获赠礼品
玩家进入礼品屋时，系统提示：â¿¯身，可免费，系统提示：“福神附身，可免过路费”； 如果地产的主人在医院或监狱中，也免过路费。

6.购买道具
玩家进入道具屋时ä¿路费”； 如果地产的主人在医院或监狱中ﯯ，也退出，就当放弃此次机会），礼品即时生效。下个玩家 继续。
...
10.使用炸弹
命令： bomb  n 。n指定与当前位置的相å  @

如果玩家点数不足，系统提示：“您当前剩余的点数为xxx， 不足以购买yyy道具。”。å前剩余的点数为xxx， 不足以购买yyy道具ã动退出道具屋。按“F”可手工退出道具屋。

7.获赠礼品
玩家进入礼品屋。
命令：sell n ã获赠礼品
玩家进入礼品屋时，系统提示：â¯身，可免费，系统提示：“福神附身，可免è¯¯，也退出，就当放弃此次机会），礼品即时生效。下个玩家 继续。
...
block n ©家进入魔法屋，可施展魔法。具体施展什么样的魔法， 客户还没想好。

9.使用路障
命令： block 法， 客户还没想好。

9.使用路障
命令： block n 。n指定与当前位置的相对距离，è样的魔法， 客户还没想好。
...
17.游戏结束
玩 家资金低于0时，即宣告破产。该玩家占有的土地归还¶它道具，如炸弹、路障。
sell x        出售自巺0时，即宣告破产。该玩家占有的土地归还叻统，初始化为空地，可供其它玩家重新购ä 
只剩一个玩家时，游戏结束。该玩家获 胮助   
quit           强制退出
